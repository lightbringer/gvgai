...
public class DiscreteGameState implements GameState {
    ...
    @Override
    public Object getDirection( VGDLSprite s ) {
        return positions.get( s ).direction;
    }
    ...
    @Override
    public boolean move( VGDLSprite s, Object direction ) {
        final SpritePosition.Direction d = (SpritePosition.Direction) direction;
        switch (d) {
            case EAST:
                return moveRight( s );
            case NORTH:
