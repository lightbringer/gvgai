...
The first aspect to realize is that learning can be appreciated in $8$ out of the $10$ games employed in the experimental study. The exceptions are \textit{Portals} (where the score is $0$ through the whole process) and \textit{Sokoban} 
